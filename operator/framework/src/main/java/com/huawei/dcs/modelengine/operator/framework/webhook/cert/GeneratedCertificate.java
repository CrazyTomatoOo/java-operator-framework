 ...
 */
public record GeneratedCertificate(X509Certificate caCertificate, X509Certificate serverCertificate,
        PrivateKey serverPrivateKey, byte[] caCertificatePem, byte[] serverCertificatePem, byte[] serverPrivateKeyPem,
        Path caPath, Path serverCertificatePath, Path serverPrivateKeyPath) {
    /**
